...
public class ChargingStationMode2 extends AutoModeBase {
    RobotState mRobotState = RobotState.getInstance();
    
    public ChargingStationMode2(TargetedObject gameObject, boolean aquireObject)
    {
       // setStartingPosition(TargetedPositions.GRID_5, SwerveRotation.FRONT_FACING_GRID);
        Pose2d chargingStationPose = new Pose2d(FieldConstants.Community.chargingStationBackBalancePoint,SwerveRotation.FRONT_FACING_GRID.getRotation());
        addAction(new DriveToPose(chargingStationPose));
        /* 
