...
public class StartG9_ScoreH9_IntakeO4_ScoreM9 extends AutoModeBase {

    public StartG9_ScoreH9_IntakeO4_ScoreM9(){
        ...
        //addAction(new MoveArmAction(ArmTargets.HOME_FRONTSIDE))

        //addAction(new DriveToPose(GRID_7, front facing grid));
