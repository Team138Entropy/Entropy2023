...
public class EntropyVisionSim {
    ...
    ArrayList<EntropySimVisionTarget> tgtList;
     ...
     */
    public void addSimVisionTarget(EntropySimVisionTarget target) {
        tgtList.add(target);
        dbgField
    ...
    public void processFrame(Pose3d robotPoseMeters) {
        ...
        tgtList.forEach(
                (tgt) -> {
                    ...
                    // modified to flip yaw... real camera gives off yaw rotated
                    double yawDegrees = -1 * camToTgtRotation.minus(camAngle).getDegrees();                    
