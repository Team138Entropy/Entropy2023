...
public class Enums {
    ...
    public enum ArmTargets {
        ...
        INTAKE_FRONT(-5,Constants.Arm.MinExtensionPosition),
        INTAKE_FRONT_CUBE(-3, Constants.Arm.MinExtensionPosition),
        ...
        LOW_SCORING_BACK(210,50000),
        INTAKE_BACK(173,0),
        INTAKE_BACK_CUBE(172,0),
        POST_INTAKE_BACK(167,0),
        INTAKE_GROUND_FRONT(-57,174000),
        INTAKE_GROUND_FRONT_CUBE(-57,162000),
        INTAKE_GROUND_BACK(223,208000),
        INTAKE_GROUND_BACK_LOWER(223,220000),
        SAFE(90,0),
        START(233, 0),
        HOME_BACKSIDE(220, 0),
        HOME_FRONTSIDE(-50, 0),
